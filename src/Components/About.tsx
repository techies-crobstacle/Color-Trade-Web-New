  ...
  return (
    <div className="bg-[#242424] flex-1 min-h-screen">
      ...
      <div className="p-3 sm:p-5 flex flex-col gap-3 sm:gap-5">
        ...
        <Link 
          href="/privacy" 
          className="bg-white/10 flex justify-between items-center p-3 sm:p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow"
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            />
            <h3 className="font-semibold text-white text-sm sm:text-lg">Confidentiality Agreement</h3>
          </div>
          <Image
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            <Image
              ...
              className="w-8 sm:w-9 flex-shrink-0"
            />
            <h3 className="font-semibold text-white text-sm sm:text-lg">Risk Disclosure Agreement</h3>
          </div>
          <Image
            className="w-5 h-5 sm:w-7 sm:h-7 flex-shrink-0"
            src="/right-next.svg"
