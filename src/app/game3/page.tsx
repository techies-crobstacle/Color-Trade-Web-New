...
// import Min3Game3 from '@/Components/Games/Min3Game3';
...
//                 >
//                   <Image
//                     className={`w-7 ${tab.id === "3MinGame3" ? "" : "grayscale"}`}
//                     src={tab.img}
//                     alt=""
//                     width={100}
//                     height={100}
...
//                       tab.id === "3MinGame3" ? "text-white" : "text-gray-400"
//                     }`}
//                   >
//                     Win Go
//                   </h1>
      ...
      <div className="bg-[#333332] rounded-2xl -mt-9 mx-2 sm:mx-3">
        <div className="w-full p-2 sm:p-4 bg-[#333332] rounded-2xl mt-4">
          <div className="flex gap-1 sm:gap-2 mb-4 shadow-md bg-white/10 rounded-xl overflow-hidden">
           {tabs.map((tab) => {
              const isActive = tab.id === "3MinGame3";
