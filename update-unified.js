...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  // Vibrant distinct color palette for numbers 0-9
  const numberColors = ['#FF499E', '#FFCA3A', '#8AC926', '#1982C4', '#6A4C93', '#F15BB5', '#00BBF9', '#00F5D4', '#FEE440', '#9B5DE5'];
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 min-h-full">
        ...
        <div className="xl:col-span-2 bg-white border border-gray-200 rounded-xl p-5 shadow-sm ring-1 ring-black/5 relative overflow-hidden flex flex-col items-center justify-center min-h-[380px]">
          ...
          <div className="relative w-72 h-72 z-10 mt-8 group flex items-center justify-center">
            ...
            <svg viewBox="-10 -10 220 220" className="w-full h-full transform -rotate-90 filter drop-shadow-md overflow-visible relative z-30">
              ...
              {['Big', 'Small'].map(s => {
                 ...
                 const circle = (
                   <circle key={s} cx="100" cy="100" r="40" fill="transparent" 
                     stroke={s==='Big'?'#F59E0B':'#3B82F6'} strokeWidth="12"
          ...
          <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-6 z-10 scale-90">
             ...
             <div className="flex items-center gap-1.5 bg-gray-50 px-2 py-1 rounded shadow-sm border border-gray-100"><div className="w-2 h-2 bg-[#F15BB5] rounded"></div><span className="text-[10px] font-bold">Outer: Number</span></div>
          </div>
        </div>
